...
describe('ripple-cdr-openehr/lib/src/postHeading', () => {
  let postHeading;
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('../../../lib/src/postHeading')];
    postHeading = require('../../../lib/src/postHeading');
  ...
  it('should post heading and return false when no data returned', (done) => {
    ...
    startSessionHttpMock(fakeResponses.session);
    httpEhrMock(sessionId, fakeResponses.ehr);
    httpPostHeadingMock(sessionId, ehrId);
