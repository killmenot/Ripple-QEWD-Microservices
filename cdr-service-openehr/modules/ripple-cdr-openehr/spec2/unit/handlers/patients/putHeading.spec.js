...
describe('ripple-cdr-openehr/lib/handlers/patients/putHeading', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../commands/patients', { PutPatientHeadingCommand });

    delete require.cache[require.resolve('../../../../lib2/handlers/patients/putHeading')];
    handler = require('../../../../lib2/handlers/patients/putHeading');
  });
