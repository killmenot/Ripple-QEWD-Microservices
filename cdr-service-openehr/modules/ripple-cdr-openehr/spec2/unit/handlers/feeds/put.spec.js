...
describe('ripple-cdr-openehr/lib/handlers/feeds/put', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../commands/feeds', { PutFeedCommand });

    delete require.cache[require.resolve('../../../../lib2/handlers/feeds/put')];
    handler = require('../../../../lib2/handlers/feeds/put');
  });
