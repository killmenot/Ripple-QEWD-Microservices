...
const jumper = require('../../../lib2/jumper');
const JumperService = require('../../../lib2/services/jumperService');

describe('ripple-cdr-openehr/lib/services/jumperService', () => {
  let ctx;
  let jumperService;
  ...
  describe('#check', () => {
    ...
    it('should return non ok when heading config is not defined', async () => {
      ...
      delete ctx.userDefined.headings.vaccinations;
    ...
    it('should return non ok when heading config template name is not defined', async () => {
      ...
      delete ctx.userDefined.headings.vaccinations.template.name;
      delete ctx.userDefined.headings.vaccinations.synopsisField;
      delete ctx.userDefined.headings.vaccinations.summaryTableFields;
