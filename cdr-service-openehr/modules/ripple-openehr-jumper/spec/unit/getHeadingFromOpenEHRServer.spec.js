...
const openEHR = require('../../../ripple-cdr-openehr/lib/src/openEHR');

describe('ripple-openehr-jumper/lib/getHeadingFromOpenEHRServer', () => {
  let q;
  let qewdSession;
  let aql;
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('../../lib/getHeadingFromOpenEHRServer')];
    getHeadingFromOpenEHRServer = require('../../lib/getHeadingFromOpenEHRServer');
  ...
  describe('handle valid response', () => {
    ...
    it('should save a top level copy of the raw response', (done) => {
      ...
      setTimeout(() => {
        /*jshint camelcase: false */
        const headingPath = path.join(q.userDefined.paths.jumper_templates, 'allergies');
        /*jshint camelcase: true */
