...
describe('ripple-openehr-jumper/lib/getPatientTemplateData', () => {
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../ripple-cdr-openehr/lib/src/fetchAndCacheHeading', fetchAndCacheHeading);

    getPatientDataFromCache = jasmine.createSpy();
    mockery.registerMock('./getPatientDataFromCache', getPatientDataFromCache);

    delete require.cache[require.resolve('../../lib/getPatientTemplateData')];
    getPatientTemplateData = require('../../lib/getPatientTemplateData');
