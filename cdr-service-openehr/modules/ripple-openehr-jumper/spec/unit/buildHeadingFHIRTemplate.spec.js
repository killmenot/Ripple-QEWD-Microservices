...
describe('ripple-openehr-jumper/lib/buildHeadingFHIRTemplate', () => {
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('../../lib/buildHeadingFHIRTemplate')];
    buildHeadingFHIRTemplate = require('../../lib/buildHeadingFHIRTemplate');
  });
