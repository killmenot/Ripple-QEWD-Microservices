...
describe('ripple-openehr-jumper/lib/processWebTemplate', () => {
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('../../lib/processWebTemplate')];
    processWebTemplate = require('../../lib/processWebTemplate');

    fsMock({
      'spec/templates/allergies': {}
    });
  });
