...
describe('ripple-openehr-jumper/lib/buildFHIRToOpenEHR', () => {
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('../../lib/buildFHIRToOpenEHR')];
    buildFHIRToOpenEHR = require('../../lib/buildFHIRToOpenEHR');
  });
