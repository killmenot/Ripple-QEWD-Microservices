...
describe('ripple-openehr-jumper/lib/createJSONSchema', () => {
  ...
  beforeEach(() => {
    ...
    metadata = [];
    filePath = '/path/to/templates/allergies';

    buildJsonFile = jasmine.createSpy();
    mockery.registerMock('./buildJsonFile', buildJsonFile);

    delete require.cache[require.resolve('../../lib/createJSONSchema')];
    createJSONSchema = require('../../lib/createJSONSchema');
  });
