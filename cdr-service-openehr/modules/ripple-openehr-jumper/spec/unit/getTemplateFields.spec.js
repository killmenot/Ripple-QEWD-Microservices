...
const getTemplateFields = require('../../lib/getTemplateFields');

describe('ripple-openehr-jumper/lib/getTemplateFields', () => {
  let q;
  let templateName;
  ...
  it('should return template fields with default jumperTemplateFields', () => {
    delete q.userDefined.documentNames.jumperTemplateFields;
