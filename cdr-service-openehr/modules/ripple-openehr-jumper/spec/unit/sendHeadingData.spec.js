...
const sendHeadingData = require('../../lib/sendHeadingData');

describe('ripple-openehr-jumper/lib/sendHeadingData', () => {
  let q;
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('../../../ripple-cdr-openehr/lib/src/openEHR')];
    openEHR = require('../../../ripple-cdr-openehr/lib/src/openEHR');
